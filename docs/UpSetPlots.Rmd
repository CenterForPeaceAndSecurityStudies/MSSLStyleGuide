...
Essentially, UpSet plots are a concise and easy-to-understand version of a Venn Diagram. Rather than looking at several proportional overlapping circles, one can view the frequencies of the interactions of given variables in bar-plot form. They are very easy to plot in R, are incredibly useful for conveying information concerning multiple variables and their interactions, and there exists several useful resources online (see the final section of this R Markdown file.
