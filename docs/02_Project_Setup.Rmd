...
1. Open RStudio and run the following:

```{r}

install.packages("devtools")
devtools::install_github("r-lib/usethis")
tmp <- file.path("~/Dropbox (rex)/github_private", "mypkg")
create_package(tmp)

```

2. A new project session will open in RStudio. In the new session run:
...
dir.create(file.path(paste0(tmp,"/inst"), "extdata"))
dir.create(file.path(tmp, "paper"))
dir.create(file.path(paste0(tmp,"/paper"), "figures"))
